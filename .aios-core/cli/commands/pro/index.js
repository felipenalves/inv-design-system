  ...
  try {
    ...
    if (fs.existsSync(proSourceDir)) {
      ...
      try {
        ...
        console.log(
          'Note: Pro scaffolder not available. Skipping content scaffolding.',
        )
        console.log('')
      }
      ...
      if (scaffoldProContent) {
        ...
        const scaffoldResult = await scaffoldProContent(
          projectRoot,
          proSourceDir,
          {
        ...
        if (scaffoldResult.success) {
          ...
          console.error(
            'Pro features are activated but content was not copied.',
          )
          console.error(
            'Try running "aios pro activate" again to retry scaffolding.',
          )
        }
        console.log('')
      }
      ...
      console.log(
        'Note: @aios-fullstack/pro package not found in node_modules.',
      )
      console.log(
        'Pro content will be scaffolded when the package is installed.',
      )
      console.log('')
    }
  } catch (error) {
